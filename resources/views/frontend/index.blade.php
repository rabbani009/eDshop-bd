  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
        ...
        <!-- === == TOP NAVIGATION == ==== -->
       @include('frontend.common_user_panel.vertical_menu')
        <!-- ===== ==== TOP NAVIGATION : END ==== ===== --> 
        
        
        <!-- === ===== HOT DEALS ======= ===== -->
        @include('frontend.common_user_panel.hot_deals')
        <!-- === === HOT DEALS: END ====== ===== --> 
 ...
 <div class="product-price"> <span class="price"> ${{ $product->selling_price }} </span> </div>
   ...
   @foreach($special_deals as $product)
      ...
      @endforeach <!-- // end special deals foreach -->
        ...
        <!-- == ==== Testimonials=== ===== -->
         @include('frontend.common_user_panel.testimonials')
